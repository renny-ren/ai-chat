...
const Header: React.FC<HeaderProps> = ({ isAddContext, handleContextChange }) => {
  ...
  const onShare = async () => {
    copy(`${window.location.origin}/developer_assistant`)
      ...
      <div className="group z-10">
        ...
        >
          <div className="px-4 sm:px-0">
            <p className="mt-1 max-w-2xl text-sm leading-6 font-medium text-gray-600">程序员助手</p>

            <div className="flex justify-between items-end">
              <div className="mt-1 max-w-2xl text-xs text-gray-600 flex items-center">
                <span>欢迎向我提问，回答不完整时可回复「继续」</span>
              </div>
