        ...
        <Popover className="relative">
          {({ open }) => (
            <>
              ...
              >
                <Badge color="#32c48e" dot={unreadCount > 0} offset={[-1, 2]} className="block">
                    ...
                    <div className="bg-gray-50 px-4">
                      <div className="flow-root rounded-md px-2 py-2">
                        <span className="flex items-center justify-between">
                          ...
                          <button className="text-sm text-[#1677ff] hover:underline" onClick={onReadAll}>
                        ...
                        {notifications.length ? (
                          <>
                            {notifications.map((item, i) => (
                              ...
                              >
                                {!item.read_at && !readIds.includes(item.id) && (
                                  <Badge status="processing" className="absolute" />
                                )}
