...
const NotificationPopup: React.FC<NotificationPopupProps> = ({ notifications, isOpen, closePopup, renderer }) => {
  return (
    <Transition
      as={Fragment}
      show={isOpen}
          ...
          <div className="mt-2 space-y-5">
            <div className="relative mx-auto max-w-[400px] rounded-md border border-gray-50 bg-white p-4 text-sm shadow-lg">
              <button
                ...
                className="ttop-4 absolute right-4 ml-auto text-gray-500 hover:text-gray-900"
              >
